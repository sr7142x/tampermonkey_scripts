...
// @match       https://app.fastmail.com/mail/Inbox/*
// @grant       GM_getValue
// @grant       GM_setValue
// @version     1.1
// @author      -
...
(()=>{
  ...
  // if have a stored user, and the path needs to change
  if( stored_user !== undefined && (/login/.test(window.location.href) || window.location.href==="https://www.fastmail.com/" ) ){
    console.log('moving to stored user ${stored_user}');
    window.location.href = `https://app.fastmail.com/mail/Inbox?u=${stored_user}`;
  }
})();
